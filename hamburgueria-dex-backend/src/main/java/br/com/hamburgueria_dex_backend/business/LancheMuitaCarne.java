...
public class LancheMuitaCarne extends CalcularDescontoLanches {

    public LancheMuitaCarne(CalcularDescontoLanches proximo) {
        super(proximo);
    }
        ...
        for (Lanches lanche : cardapio.getLanches()) {
            ...
            for (Ingredientes ingrediente : ingredientes) {
                ...
                if (ingrediente.getNome().equals("Bacon") && ingrediente.getQuantidade().compareTo(new BigDecimal("3")) >= 0) {
                    ...
                    lanche.setPromocao(Promocao.MUITA_CARNE.name());
